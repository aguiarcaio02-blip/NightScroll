  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <div className="px-4 py-6 pb-20 max-w-3xl mx-auto space-y-8 text-sm leading-relaxed text-gray-300">
        ...
        {/* 1. What Are Cookies */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">1. What Are Cookies?</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">2. Types of Cookies We Use</h2>
        ...
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">3. Third-Party Cookies</h2>
          <p>
        ...
        {/* 4. Managing Cookies */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">4. How to Manage and Disable Cookies</h2>
          <p>
        ...
        {/* 5. Consent */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">5. Consent</h2>
          <p>
        ...
        {/* 6. Do Not Track */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">6. Do Not Track Signals</h2>
          <p>
        ...
        {/* 7. Changes */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">7. Changes to This Cookie Policy</h2>
          <p>
        ...
        {/* 8. Contact */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">8. Contact Us</h2>
          <p>
