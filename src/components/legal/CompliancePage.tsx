  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <div className="px-4 py-6 pb-20 max-w-3xl mx-auto space-y-8 text-sm leading-relaxed text-gray-300">
        ...
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">1. Platform Classification and Exemption</h2>
          <p>
        ...
        {/* 2. Age Verification */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">2. Age Verification of Content Creators</h2>
          <p>
        ...
        {/* 3. Records Custodian */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">3. Custodian of Records</h2>
          <p>
          ...
          <div className="mt-3 p-4 bg-white/5 rounded-lg border border-white/10">
            ...
            <p className="mt-2 text-xs text-gray-400">Records are maintained at the principal office of NightScroll and are available for inspection during normal business hours as required by applicable law.</p>
          </div>
        </section>

        {/* 4. Content Creator Obligations */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">4. Content Creator Obligations</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">5. Commitment to Removing Illegal Content</h2>
          <p>
        ...
        {/* 6. Reporting */}
        <section>
          <h2 className="text-[#D946EF] text-base font-semibold mb-3">6. Reporting Suspected Illegal Content</h2>
          <p>
