  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <div className="px-lg py-lg pb-[100px] max-w-[600px] mx-auto space-y-xl text-[14px] leading-[1.7] text-[#AAAAAA]">
        ...
        {/* 1. Eligibility */}
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">1. Eligibility</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">2. Account Registration and Responsibilities</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">3. Prohibited Content and Conduct</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">4. Content Ownership and License Grant</h2>
          <p>
        ...
        {/* 5. DMCA Compliance */}
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">5. Digital Millennium Copyright Act (DMCA) Compliance</h2>
          <p>
        ...
        {/* 6. Termination */}
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">6. Termination</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">7. Disclaimers and Limitation of Liability</h2>
          <p className="uppercase text-[11px] text-[#888888]">
          ...
          <p className="uppercase text-[11px] text-[#888888] mt-md">
        ...
        {/* 8. Indemnification */}
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">8. Indemnification</h2>
          <p>
        ...
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">9. Governing Law and Dispute Resolution</h2>
          <p>
        ...
        {/* 10. Modifications */}
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">10. Modifications to Terms</h2>
          <p>
        ...
        {/* 11. Severability */}
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">11. Severability</h2>
          <p>
        ...
        {/* 12. Contact */}
        <section>
          <h2 className="text-[#D946EF] text-[16px] font-bold mb-md">12. Contact Information</h2>
          <p>
